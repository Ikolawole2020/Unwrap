...
#     productToAdd = []
#     if form.validate_on_submit():
#         productToAdd = Products.query.filter_by(name = form.name.data, price=form.price.data, description=form.description.data)
#         db.session.add(productToAdd)
#         db.session.commit()
        
#     return render_template('addprod.html', form=form, productToAdd=productToAdd)
